# -*- coding: utf-8 -*-
"""Cópia de Cópia de Aula1_Introducao_ao_Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1uoC-yuNFXo3_bvhA7jMoXDdm3_I3XZ8L
...
if idade>=18:
  print(f"caro(a) {nome} voce é maior de idadde")
else:
  print(f"caro(a) {nome} voce é menor de idade")
...
temperatura_celsius = float(input("digite sua temperatura:"))

temperatura_fahrenheit = (temperatura_celsius * 9/5) + 32

print(f"sua temperatura em fahrenheit é: {temperatura_fahrenheit}")
...
numero_frase = len(frase)

print(f"sua frase tem {numero_frase} caracteres.")
...
numero_1 = float(input("1° numero:"))
numero_2 = float(input("2° numero:"))
...
n2 = int(input("digite a segunda note:"))
n3 = int(input("digite a terceira note:"))
...
horas_trab = int(input("digite a quantidade de horas trabalhadas no mes:"))
valor_hora = float(input("digite quanto ganha por hora"))

salario_mensal = horas_trab * valor_hora

print(f"seu salario mensal é: {salario_mensal}")
...
juros_anual = (float(input("juros: ")))
anos = int(input("anos: "))

juros_compostos_1 = deposito * (1 + juros_anual /100) ** anos

print(f"valor acumulado apos {anos} ano(s): {juros_compostos_1}")
...
"""**Exercício 20**:
Faça um programa que receba o valor de um salário e o percentual de aumento. Calcule e exiba o novo salário com o reajuste aplicado. -INSS 8% -FGTS 5% -VT 120 -IR 7.5%
"""
